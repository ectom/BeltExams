...
var ApiService = (function () {
    ...
    ApiService.prototype.destroy = function (id) {
    ...
    ApiService.prototype.vote = function (id, str) {
...
var routes = [
    ...
    },
    {
        path: 'show/:id',
        pathMatch: 'full',
        component: __WEBPACK_IMPORTED_MODULE_5__show_show_component__["a" /* ShowComponent */],
        children: []
    },
];
...
module.exports = "<div>\n    <h3>Put your question and options here:</h3>\n\n    <p><a [routerLink]='[\"/dashboard\"]'>Cancel</a></p>\n    <form #form='ngForm'>\n        <p><label>Question:</label><input type=\"text\" name=\"question\" value=\"\" required minlength='8' #question='ngModel' [(ngModel)]='poll.question'></p>\n        <p><label>Option 1:</label><input type=\"text\" name=\"option1Name\" value=\"\" required minlength='3' #option1Name='ngModel' [(ngModel)]='poll.option1Name'></p>\n        <p><label>Option 2:</label><input type=\"text\" name=\"option2Name\" value=\"\" required minlength='3' #option2Name='ngModel' [(ngModel)]='poll.option2Name'></p>\n        <p><label>Option 3:</label><input type=\"text\" name=\"option3Name\" value=\"\"required minlength='3' #option3Name='ngModel' [(ngModel)]='poll.option3Name'></p>\n        <p><label>Option 4:</label><input type=\"text\" name=\"option4Name\" value=\"\" required minlength='3' #option4Name='ngModel' [(ngModel)]='poll.option4Name'></p>\n        <p><button [routerLink]='[\"/dashboard\"]' (click)='onSubmit()' type=\"submit\" name=\"button\" [disabled]='!form.valid'>Create Poll</button></p>\n    </form>\n</div>\n"
...
module.exports = "<div>\n    <h1>Hi {{user.name}}!</h1>\n    <p><a [routerLink]=\"['/create']\">Create a New Poll</a> | <a [routerLink]=\"['']\">Logout</a></p>\n    <h3>Current Polls</h3>\n\t<table>\n\t\t<tr>\n\t\t\t<th>Name</th>\n\t\t\t<th>Survey Question</th>\n\t\t\t<th>Date Posted</th>\n            <th>Action</th>\n\t\t</tr>\n\t\t<tr *ngFor=\"let poll of polls\">\n\t\t\t<td>{{poll.user}}</td>\n\t\t\t<td><a [routerLink]=\"['/show', poll._id ]\">{{poll.question}}</a></td>\n            <td>{{poll.createdAt}}</td>\n\t\t\t<td *ngIf='poll.user==user.name'><a [routerLink]=\"['/dashboard']\" (click)='destroy(poll._id)'>Delete</a></td>\n            <td *ngIf='poll.user!=user.name'></td>\n\t\t</tr>\n\t</table>\n</div>\n"
...
var DashboardComponent = (function () {
    ...
    DashboardComponent.prototype.destroy = function (id) {
...
module.exports = "<div>\n\t<h1>Survey</h1>\n\t<form #form='ngForm'>\n\t\t<p>Name: <input type=\"text\" name=\"name\" required minlength=\"2\" [(ngModel)]=\"user.name\" #name='ngModel'></p>\n        <p><button [routerLink]=\"['/dashboard']\" [disabled]=\"!form.valid\" (click)=\"onClick()\" type=\"submit\" name=\"button\">Login</button></p>\n\t</form>\n</div>\n"
...
module.exports = "<div>\n\n    <h3>{{poll | json}}</h3>\n    <p><a [routerLink]='[\"/dashboard\"]'>Go to Polls</a></p>\n\n    <table>\n        <tr>\n            <th>Option</th>\n            <th>Current Count of Votes</th>\n            <th>Action</th>\n        </tr>\n        <tr>\n            <td>{{poll.option1Name}}</td>\n            <td>{{poll.votes1}}</td>\n            <td><button type=\"sumbit\" name=\"button\" (click)='vote(poll._id, \"votes1\")'>Vote</button></td>\n        </tr>\n        <tr>\n            <td>{{poll.option2Name}}</td>\n            <td>{{poll.votes2}}</td>\n            <td><button type=\"sumbit\" name=\"button\" (click)='vote(poll._id, \"votes2\")'>Vote</button></td>\n        </tr>\n        <tr>\n            <td>{{poll.option3Name}}</td>\n            <td>{{poll.votes3}}</td>\n            <td><button type=\"sumbit\" name=\"button\" (click)='vote(poll._id, \"votes3\")'>Vote</button></td>\n        </tr>\n        <tr>\n            <td>{{poll.option4Name}}</td>\n            <td>{{poll.votes4}}</td>\n            <td><button type=\"sumbit\" name=\"button\" (click)='vote(poll._id, \"votes4\")'>Vote</button></td>\n        </tr>\n    </table>\n    {{poll | json }}\n</div>\n"
...
var ShowComponent = (function () {
    function ShowComponent(_api, _route, route) {
        this._api = _api;
        this._route = _route;
        this.route = route;
        this.user = {};
    ...
    ShowComponent.prototype.getOne = function () {
        var _this = this;
        this._route.paramMap
            .switchMap(function (params) {
            return _this._api.getOne(params.get('id'));
        })
            .subscribe(function (data) { return _this.poll = data; });
    };
    ShowComponent.prototype.vote = function (id, str) {
        this._api.vote(id, str)
            .then(function (data) { console.log('then'); })
